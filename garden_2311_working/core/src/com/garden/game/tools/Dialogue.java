...
public class Dialogue {
    ...
    public static String dia_intro_2 = MainCharacter + "'Good morning to you also'";
    public static String dia_intro_3 = MainCharacter + BOSS + "!";

    public static String dia_intro_4 = BOSS + "'So you are our new park employee'";
    public static String dia_intro_5 = BOSS + "'And you are of course aware of what your need to do!'";

    public static String dia_intro_6 = MainCharacter + "'No! not at all'";
